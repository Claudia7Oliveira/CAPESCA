...
class Estrutura_model extends CI_Model {
	...
	public function listar_publicacao($pular=null,$post_por_pagina=null){
		...
		return $this->db->get('estrutura')->result();
	}
...
//pra alteraçoes
	...
	public function adicionar($titulo,$conteudo,$datapub){
		...
		return $this->db->insert('estrutura',$dados);
	}
	
	public function excluir($id){
		$this->db->where('md5(id)',$id);
		return $this->db->delete('estrutura');
	}
	public function alterar($titulo,$conteudo,$datapub,$id){
		...
		$this->db->where('id',$id);
		return $this->db->update('estrutura',$dados);
	}
	...
	public function contar(){
		return $this->db->count_all('estrutura');
	}
