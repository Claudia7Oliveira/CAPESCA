      ...
      <div class="card card-primary">
          ...
          <div class="panel-body">
            <div class="row" style="padding-bottom: 10px;">
              <div class="col-lg-8 col-lg-offset-1">
                <?php 
                if($post->img == 1){
                  echo img("assets/frontend/img/agenda/".md5($post->id).".jpg");
                }else{
            ...
            <div class="row">
              <div class="col-lg-12">
                <?php
                  ...
                  $divclose= '</div>';
                    echo form_open_multipart('admin/agenda/nova_foto');
       ...
       <div class="card-body">
        <?php
         ...
         echo form_open('admin/agenda/salvar_alteracoes/'.md5($post->id).'/'.$post->user);
        ?>
