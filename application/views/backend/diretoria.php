      ...
      <div class="col-md-12"> 
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Adicionar à diretoria:</h3>
          </div>
            <div class="card-body">
            <?php
             echo validation_errors('<div class="alert alert-danger text-center">','</div>');
             echo form_open_multipart('admin/diretoria/inserir');
            ?>
            ...
            <div class="form-group">
                ...
                <input type="text" id="txt-conteudo" name="txt-conteudo" class="form-control" placeholder="Digite o titulo" value="<?= set_value('txt-subtitulo') ?>">
            </div>
  ...
  <section class="content">
   <div class="col-md-12">
        <div class="card card-secondary">
          <div class="card-header">
            <h3 class="card-title">Alterar hitorias existentes:</h3>
                      ...
                      img{ 
                         ...
                         <?php
                          ...
                          foreach($publicacoes as $post){
                              $titulo= $post->titulo;
                              if($post->img == 1){
                              $fotopub = img("assets/frontend/img/diretoria/".md5($post->id).".jpg");
                              }else{
                              $fotopub= img("assets/frontend/img/semFoto2.png");
                              }
                              $data= postadoem($post->data);
                              $alterar= anchor(base_url('admin/diretoria/alterar/'.md5($post->id)),'<i class="fa fa-refresh fa-fw"></i> Alterar');
                              $excluir= anchor(base_url('admin/diretoria/excluir/'.md5($post->id)),'<i class="fa fa-remove fa-fw"></i> Excluir');
