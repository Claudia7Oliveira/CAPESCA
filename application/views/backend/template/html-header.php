...
<head>
  ...
  <title>Capesca - area administrativa</title>
  <link rel="shortcut icon" type="image/png" href="<?php echo base_url('assets/frontend/img/capesca_negativo.png') ?>" />
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?php echo base_url('assets/backend/assets/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css')?>">
  <!-- Tempusdominus Bbootstrap 4 -->
  <link rel="stylesheet" href="<?php echo base_url('assets/backend/assets/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')?>">
  <!-- iCheck -->
