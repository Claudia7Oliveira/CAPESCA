      ...
      <div class="col-md-12"> 
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Adicionar aos ex diretores:</h3>
          </div>
            <div class="card-body">
            <?php
             echo validation_errors('<div class="alert alert-danger text-center">','</div>');
             echo form_open_multipart('admin/exdiretoria/inserir');
            ?>
  ...
  <section class="content">
   <div class="col-md-12">
        <div class="card card-secondary">
          <div class="card-header">
            <h3 class="card-title">Alterar ex diretores cadastrados:</h3>
                      ...
                      img{ 
                         ...
                         <?php
                          ...
                          foreach($publicacoes as $post){
                              $titulo= $post->titulo;
                              if($post->img == 1){
                              $fotopub = img("assets/frontend/img/exdiretoria/".md5($post->id).".jpg");
                              }else{
                              $fotopub= img("assets/frontend/img/semFoto2.png");
                              }
                              $data= postadoem($post->data);
                              $alterar= anchor(base_url('admin/exdiretoria/alterar/'.md5($post->id)),'<i class="fa fa-refresh fa-fw"></i> Alterar');
                              $excluir= anchor(base_url('admin/exdiretoria/excluir/'.md5($post->id)),'<i class="fa fa-remove fa-fw"></i> Excluir');
